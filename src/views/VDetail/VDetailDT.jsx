    ...
    return (
        <>
            <NoScrollContainer>
                ...
                <OverlayContainer>
                    <DetailCardDT moment={props.moment} comments={props.comments} update={props.update} erase={props.erase} like={props.like} save={props.save} createComment={props.createComment} />
                </OverlayContainer>
